# Видео просмотрел, но признаюсь честно - код из видео не переписывал)
# Просто скопировал его отсюда)
# https://github.com/sergei4e/django2/commit/dd8d6452653bef2928edcf13a78ac98fb1d925fa
# С темой этого урока более-менее знаком, полагаю в следующих понадобится чуть больше кастомизации)
